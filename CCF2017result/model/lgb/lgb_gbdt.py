...
grd=GradientBoostingClassifier(n_estimators=50,max_depth=8,learning_rate=0.02,max_leaf_nodes=10)
grd_enc=OneHotEncoder()
grd.fit(train_data,y_train)
grd_enc.fit(grd.apply(train_data)[:,:,0])
a=grd_enc.transform(grd.apply(train_data)[:,:,0])
a=pd.DataFrame(a.todense())
b=grd_enc.transform(grd.apply(test_data)[:,:,0])
b=pd.DataFrame(b.todense())
b.index=test_data.index
...
test_result.to_csv('C:/Luoshichao/ccf_4/result/lgb_gbdt.csv',index=None,encoding='utf-8')
'''
a.to_csv('C:/Luoshichao/ccf_4/quarter-final/input/processedData/a.csv',encoding='utf-8')
b.to_csv('C:/Luoshichao/ccf_4/quarter-final/input/processedData/b.csv',encoding='utf-8')
'''